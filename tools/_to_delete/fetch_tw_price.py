...
用法：
    python3 tools/fetch_tw_price.py 2330 --months 24
    python3 tools/fetch_tw_price.py TAIEX --months 12
    python3 tools/fetch_tw_price.py 8069.TWO --months 24
    python3 tools/fetch_tw_price.py --selftest
"""
